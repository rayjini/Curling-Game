...
class Stone {
  constructor(x,y, radius, colour){
    ...
    this.radius = radius
    this.colour = colour
    this.velocityX = 0 //positive it to the screen right
    this.velocityY = 0 //postive is screen downwards
    this.isMoving = false
  }
  ...
  advance(area){
    ...
    */
    ...
    //if(this.isStoneMoving()) console.log("vx:" + this.velocityX + " vy:" + this.velocityY)
